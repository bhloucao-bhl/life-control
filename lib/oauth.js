...
import { fetchOuraUserId, OURA_SCOPES } from './oura';
...
export const PROVIDERS = {
  oura: {
    ...
    // tudo que a Oura oferece menos tags (ring_configuration: bateria do anel). Escopo que a Oura
    // não conhece é descartado calado na tela de consentimento — não quebra o login.
    scope: OURA_SCOPES,
